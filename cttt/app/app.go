...
import (
	...
	appparams "github.com/cosmos_tic_tac_toe/cttt/app/params"
	"github.com/cosmos_tic_tac_toe/cttt/x/cttt"
	ctttkeeper "github.com/cosmos_tic_tac_toe/cttt/x/cttt/keeper"
	cttttypes "github.com/cosmos_tic_tac_toe/cttt/x/cttt/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/ctttd")
	}
...
func New(
	...
	app.ctttKeeper = *ctttkeeper.NewKeeper(
        appCodec, keys[cttttypes.StoreKey], keys[cttttypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		cttt.NewAppModule(appCodec, app.ctttKeeper),
